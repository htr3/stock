...
_Generated: 2026-04-05T08:52:33.935Z_
...
Workspace `mcp.json` _(folder: stocks)_

- **c:\Users\visha\All\stocks\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\visha\AppData\Roaming\Code\User\mcp.json** — _File exists — no servers defined_
